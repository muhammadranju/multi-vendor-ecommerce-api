...
const categoriesGetByIdController = asyncHandler(async (req, res) => {
  ...
  const categoryAgg = await Category.aggregate([
    {
      $match: { category_url: categoryId },
    },
    {
      $lookup: {
        from: "categories", // assuming parent categories are in same collection
        localField: "parent",
        foreignField: "_id",
        as: "parent",
      },
    ...
    },
    {
      $project: {
        ...
        parent: {
          ...
          category_url: "$parent.category_url",
        },
      },
    },
    {
